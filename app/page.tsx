...
const ARGUMENTE = [
  {
    ...
    text: "Producem prin injecție în matrițe proprii — control total al calității de la materie primă la livrare, fără intermediari.",
    icon: (
  ...
  },
  {
    ...
    text: "Stoc permanent la depozit în Jilava, Ilfov. Onorăm comenzi de volum mare pentru firme de construcții și antreprenori.",
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.6} strokeLinecap="round" strokeLinejoin="round" className="w-7 h-7" aria-hidden="true">
  ...
  return (
    <>
      ...
      <main>
        ...
        {/* ══════════════════════════════════════════════════════════════
            2. PRODUSE FABRICATE — Grid 2×2
        ══════════════════════════════════════════════════════════════ */}
        <section
          id="produse"
          className="py-16 md:py-20 lg:py-24 bg-white"
          aria-labelledby="heading-produse"
        >
          <div className="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 mb-12">
              <div className="max-w-xl">
                ...
                <h2
                  id="heading-produse"
                  className="text-3xl md:text-[2.25rem] font-bold text-[#1a3c5e] leading-tight mb-3"
                >
                  Produse fabricate de Plast Du IV
                </h2>
                <p className="text-slate-500 leading-relaxed">
                  Fabricate prin injecție în matrițe proprii la Jilava, Ilfov.
                  Calitate controlată la fiecare lot de producție.
                </p>
              </div>
              <Link
                href="/produse"
                className="inline-flex items-center gap-1.5 text-sm font-semibold text-[#1a3c5e] hover:text-orange-500 transition-colors whitespace-nowrap flex-shrink-0"
              >
                Catalog complet
                <ChevronRight />
              </Link>
            ...
            <div className="grid sm:grid-cols-2 xl:grid-cols-4 gap-6">
              {PRODUSE.map((produs) => (
                <article
                  key={produs.slug}
                  className="group flex flex-col bg-white rounded-2xl border border-slate-200 shadow-sm hover:shadow-md hover:border-[#1a3c5e]/25 transition-all duration-200"
                >
                  {/* Imagine produs */}
                  <div className="relative w-full h-48 rounded-t-2xl overflow-hidden bg-gradient-to-br from-slate-50 via-blue-50/60 to-slate-100">
                    ...
                    <div className="absolute inset-0 flex items-center justify-center" aria-hidden="true">
                      <svg viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-16 h-16 text-[#1a3c5e]/12">
                        <circle cx="32" cy="10" r="8" fill="currentColor" opacity=".7" />
                        <rect x="28" y="16" width="8" height="40" rx="4" fill="currentColor" />
                        <ellipse cx="32" cy="18" rx="18" ry="4" fill="currentColor" opacity=".3" />
                      </svg>
                    </div>
                    {/* Badge */}
                  ...
                  <div className="flex flex-col flex-1 p-5">
                    ...
                    <div className="flex items-center justify-between gap-3 pt-3 border-t border-slate-100">
                      <div className="text-xs text-slate-500">
                        <span className="font-semibold text-slate-700">Variante:</span>{" "}
                        {produs.variante}
                      </div>
                      <Link
                        href={`/produse/${produs.slug}`}
                        className="inline-flex items-center gap-1 bg-[#1a3c5e] hover:bg-[#1a3c5e]/85 text-white text-xs font-semibold px-3 py-2 rounded-lg transition-colors flex-shrink-0"
                      >
                        Detalii
          ...
          <div className="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {ARGUMENTE.map((arg) => (
                <div
                  key={arg.titlu}
                  className="flex flex-col bg-white rounded-2xl border border-slate-200 p-7 shadow-sm"
                >
                  {/* Icon */}
        ...
        {/* ══════════════════════════════════════════════════════════════
            4. APLICAȚII — 4 carduri
        ══════════════════════════════════════════════════════════════ */}
        <section
          className="py-16 md:py-20 lg:py-24 bg-white"
          aria-labelledby="heading-aplicatii"
        >
          <div className="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-8">
            {/* Header */}
            <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 mb-12">
              <div className="max-w-xl">
                ...
                <h2
                  id="heading-aplicatii"
                  className="text-3xl md:text-[2.25rem] font-bold text-[#1a3c5e] leading-tight mb-3"
                >
                  Aplicații pentru sisteme de construcție
                </h2>
                <p className="text-slate-500 leading-relaxed">
                  Produsele Plast Du IV sunt proiectate pentru principalele sisteme de izolație
                  și finisaj utilizate în construcțiile rezidențiale și comerciale.
                </p>
              </div>
              <Link
                href="/aplicatii"
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
              {APLICATII.map((ap) => (
                <div
                  key={ap.titlu}
                  className="group flex flex-col bg-white rounded-2xl border border-slate-200 p-6 hover:border-[#1a3c5e]/25 hover:shadow-md transition-all duration-200"
                >
                  {/* Icon */}
                  ...
                  <h3 className="font-bold text-[#1a3c5e] text-[0.95rem] mb-2 leading-snug">
                    {ap.titlu}
                  </h3>
                  ...
                  <Link
                    href="/aplicatii"
                    className="mt-auto inline-flex items-center gap-1 text-[#1a3c5e] text-sm font-semibold hover:text-orange-500 transition-colors"
                  >
                    Detalii
        ...
        <section
          ...
          aria-label="Cerere ofertă — Plast Du IV"
        >
          {/* Decorative glows */}
          ...
          <div className="relative max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              {/* CTA primar — alb pe albastru */}
              <Link
                href="/contact"
                className="inline-flex items-center gap-2 bg-white text-[#1a3c5e] font-bold px-8 py-4 rounded-xl hover:bg-blue-50 active:bg-white transition-colors duration-150 shadow-xl text-base"
              >
                <svg viewBox="0 0 20 20" fill="currentColor" className="w-5 h-5 flex-shrink-0" aria-hidden="true">
                  <path d="M3 4a2 2 0 0 0-2 2v1.161l8.441 4.221a1.25 1.25 0 0 0 1.118 0L19 7.162V6a2 2 0 0 0-2-2H3Z" />
                  <path d="M19 8.839l-7.77 3.885a2.75 2.75 0 0 1-2.46 0L1 8.839V14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V8.839Z" />
              ...
              {/* CTA secundar — telefon */}
              <a
                href="tel:+40724658491"
                className="inline-flex items-center gap-2 border border-white/30 bg-white/10 hover:bg-white/20 text-white font-semibold px-8 py-4 rounded-xl transition-colors duration-150 text-base"
              >
                <svg viewBox="0 0 20 20" fill="currentColor" className="w-5 h-5 flex-shrink-0" aria-hidden="true">
