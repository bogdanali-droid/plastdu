...
const CLIENTI = [
  {
    ...
    descriere: 'Parteneriate solide cu firme de construcții și reabilitări termice din toată țara.',
    icon: (
  ...
  },
  {
    ...
    descriere: 'Aprovizionăm distribuitori în județele: București, Ilfov, Dolj, Argeș, Vâlcea, Prahova, Dâmbovița, Cluj.',
    icon: (
      <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  },
  {
    ...
    descriere: 'Aprovizionăm depozite și magazine în: București, Ilfov, Dolj, Gorj, Argeș, Vâlcea, Prahova, Dâmbovița, Brașov, Teleorman.',
    icon: (
      <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
        ...
        <section className="section-padding bg-brand-blue text-white">
          <div className="container-site text-center">
            ...
            <div className="flex flex-wrap gap-4 justify-center">
              ...
              <Link href="/produse" className="inline-flex items-center gap-2 border border-white/30 text-white font-semibold px-8 py-3.5 rounded-xl hover:bg-white/10 transition-colors">
                Vezi produsele
              </Link>
            </div>
          </div>
